...
export default class Test extends Component
{
    ...
    render()
    {
        //window.temp = this.SuccessCall;

        //window.temp = this.SignInfoCall;
        //window.temp = this.SignInCall;

        let jsonData2 = {
            TestFunc1: this.SuccessCall,
            TestFunc2: this.SignInfoCall,
            TestFunc3: this.SignInCall,
        };
        ...
        return (
            ...
            <div className="Test">
                <div onClick={this.SignInCall}>1</div>
                <button onClick={this.SignInCall}>백엔드 호출 1</button>
                테스트 입니다.
                <br />
                <br />
