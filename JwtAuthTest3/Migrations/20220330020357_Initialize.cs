    ...
    public partial class Initialize : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "test01@a.net", "Test", "01", "$2a$11$pfXM36FsjSix2CFRl8.hF.ETxRVQA/vOz5JL0hbmSb9WOotKwwXQu", new DateTime(2022, 3, 30, 11, 3, 56, 821, DateTimeKind.Local).AddTicks(2903), "", null, 0, "Test01", null, "", new DateTime(2022, 3, 30, 11, 3, 56, 821, DateTimeKind.Local).AddTicks(2889) });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "AcceptTerms", "Created", "Email", "FirstName", "LastName", "PasswordHash", "PasswordReset", "ResetToken", "ResetTokenExpires", "Role", "Title", "Updated", "VerificationToken", "Verified" },
                values: new object[] { 2, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "test02@a.net", "Test", "02", "$2a$11$BVMatbSyPZUimFf.3mOg6O20pIFk8DPMUFh.gjpRg52lIhGe.RlMa", new DateTime(2022, 3, 30, 11, 3, 56, 937, DateTimeKind.Local).AddTicks(6613), "", null, 1, "Test02", null, "", new DateTime(2022, 3, 30, 11, 3, 56, 937, DateTimeKind.Local).AddTicks(6603) });
