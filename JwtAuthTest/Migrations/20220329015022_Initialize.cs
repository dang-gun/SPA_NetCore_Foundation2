        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthDate = table.Column<DateTime>(type: "TEXT", unicode: false, nullable: false),
                    ...
                    HireDate = table.Column<DateTime>(type: "TEXT", unicode: false, nullable: false),
                    VacationHours = table.Column<short>(type: "INTEGER", unicode: false, nullable: false),
                    SickLeaveHours = table.Column<short>(type: "INTEGER", unicode: false, nullable: false),
                    RowGuid = table.Column<Guid>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "TEXT", unicode: false, nullable: false)
                },
                constraints: table =>
                {
